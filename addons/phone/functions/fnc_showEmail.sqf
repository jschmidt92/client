...
private _from = _control lbText _index;
private _email = _control lbData _index;
private _data = call compile format["%1", _email];

private _subject = _data select 0;
private _body = _data select 1;
