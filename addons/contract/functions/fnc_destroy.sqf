 ...
 *
 * Example:
 * ["task_name", 1, 2, 250000, -75, 300, false, false] spawn sof_client_contract_fnc_destroy;
 * ["task_name", 1, 2, 250000, -75, 300, false, false, 45] spawn sof_client_contract_fnc_destroy;
 *
 * Public: Yes
 */
